...
export function ProjectsSection() {
  ...
  return (
    <section id="projects" className="bg-gradient-to-br from-white via-red-50/15 to-white rounded-[2rem] p-4 sm:p-6 md:p-12 shadow-sm border border-red-100/30">
          ...
          >
            ...
            <div className="relative h-40 sm:h-48 overflow-hidden rounded-t-[2rem]">
              ...
              {project.liveUrl && (
                <a 
                  ...
                  className="absolute top-3 right-3 sm:top-4 sm:right-4 p-1.5 sm:p-2 bg-red-700 hover:bg-red-800 rounded-lg text-white transition-all shadow-md"
            ...
            <div className="p-4 sm:p-5 md:p-6 flex flex-col h-full min-h-[200px] sm:min-h-[240px] md:min-h-[280px]">
              <div className="flex-1 mb-3 md:mb-4">
                <h3 className="text-base sm:text-lg md:text-2xl font-bold text-gray-900 mb-2 leading-tight group-hover:text-red-700 transition-colors">
                  {project.title}
                </h3>
              ...
              <div className="flex flex-wrap gap-1.5 md:gap-2 mt-auto">
                {project.techStack.map(tech => (
                  <span 
                    key={tech} 
                    className="px-2 md:px-3 py-0.5 md:py-1 bg-red-50/50 text-red-700 text-[10px] sm:text-xs font-medium rounded-full border border-red-100/50 hover:bg-red-700 hover:text-white hover:border-red-600 transition-all cursor-default"
                  >
                    {tech}
                  </span>
                ))}
