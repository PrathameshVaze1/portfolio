...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-gray-100/50">
      <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left space-y-6">
          ...
          <div className="space-y-4 text-gray-600 text-lg leading-relaxed max-w-2xl">
            <p>
              I'm a <span className="font-medium text-gray-900">{displayText}</span>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
             ...
             <div className="px-4 py-2 bg-gray-50 rounded-full border border-gray-100 text-sm font-medium text-gray-600">
               3+ Years Experience
             </div>
             <div className="px-4 py-2 bg-gray-50 rounded-full border border-gray-100 text-sm font-medium text-gray-600">
               20+ Projects
