...
export function HeroSection() {
	...
	return (
		<section
			id="hero"
			className="bg-gradient-to-br from-white via-red-50/20 to-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-red-100/30"
		>
			<div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
				...
				<div className="flex-1 text-center lg:text-left space-y-4 md:space-y-6">
					...
					<div className="space-y-3 md:space-y-4 text-gray-600 text-base md:text-lg leading-relaxed max-w-2xl">
						<p>
							I'm a{" "}
							<span className="font-medium text-red-700">{displayText}</span>
