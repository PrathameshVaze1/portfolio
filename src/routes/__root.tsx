...
const siteDescription =
	"Professional Laravel Backend Developer specializing in API development, server migration, and full-stack applications. 3+ years of experience building scalable web solutions. Available for freelance Laravel projects.";
const siteKeywords =
	"Laravel Developer, Freelance Laravel Developer, PHP Developer, Laravel Backend Developer, API Development, Server Migration, Website Migration, Laravel Expert, Backend Developer India, Laravel Consultant, Prathamesh Vaze";
	...
	head: () => ({
		meta: [
			...
			},
			{
				property: "og:image",
				content:
					"https://pub-b90e26930c594e45a2ab4ae2d9976c3b.r2.dev/img/prathamesh.jpg",
			},
			{
...
function RootDocument({ children }: { children: React.ReactNode }) {
	...
	const professionalServiceSchema = {
		...
		description:
			"Professional Laravel backend development, API development, server migration, and website migration services. Expert in building scalable web applications.",
		provider: {
			"@type": "Person",
			name: personalInfo.name,
			email: personalInfo.email,
